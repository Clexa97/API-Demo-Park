...
import com.jransani.demoparkapi.service.VagaService;
import com.jransani.demoparkapi.web.dto.VagaCreateDto;
import com.jransani.demoparkapi.web.dto.VagaResponseDto;
import com.jransani.demoparkapi.web.dto.mapper.VagaMapper;
    ...
    @Operation(summary = "Criar uma nova vaga", description = "Recurso para criar uma nova vaga." +
            "Requisição exige uso de um bearer toke. Acesso restrito a Role = 'ADMIN'",
                ...
                responses = {
                        ...
                        @ApiResponse(responseCode = "422", description = "Recurso não precessado por falta de dados ou dados invalidos",
                                content = @Content(mediaType = " application/json;charset=UTF-8",
                                        schema = @Schema(implementation = ErrorMessage.class))),
