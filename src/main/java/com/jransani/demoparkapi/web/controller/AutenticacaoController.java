...
import com.jransani.demoparkapi.jwt.JwtToken;
import com.jransani.demoparkapi.jwt.JwtUserDetailsService;
import com.jransani.demoparkapi.web.dto.UsuarioLoginDto;
...
public class AutenticacaoController {
    ...
    public ResponseEntity<?> autenticar(@RequestBody @Valid UsuarioLoginDto dto, HttpServletRequest request){
        ...
        try {
            ...
            log.warn("Bad Crednecials from username '{}", dto.getUsername());
        }
